...
void set_address(uint32_t address) {
    // Shift the first 16 bits of the address onto the shift registers
    ...
    // The 17th bit is set on the MCU itself
...
/**
 * Brings the VPP pin of the ROM back to 12V, and returns control of the A9 pin to the shift registers
 */
void reset_12v() {
